...
{
	wpa_printf(MSG_DEBUG, "WPA: Parsing WPA/RSN IE (len=%lu), wpa_ie[0]=%u, wpa_ie[1]=%u, WPA_GET_BE32(&wpa_ie[2])=0x%08x",
		   (unsigned long) wpa_ie_len, wpa_ie[0], wpa_ie[1], WPA_GET_BE32(&wpa_ie[2]));
